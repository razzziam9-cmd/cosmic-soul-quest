      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <div className="relative inline-block">
          <button
            ...
            className="relative px-8 py-4 md:px-12 md:py-5 font-['Orbitron'] text-lg md:text-xl font-bold text-[#050510] bg-[#00ff88] rounded-lg transition-all duration-300 hover:scale-105 hover:bg-[#00ffaa] uppercase tracking-widest glow-button group"
          >
            <span className="relative z-10">Begin Awakening</span>
            
            {/* Button glow layers */}
            <div className="absolute inset-0 rounded-lg bg-[#00ff88] blur-md opacity-50 group-hover:opacity-75 transition-opacity" />
            <div className="absolute inset-0 rounded-lg bg-[#00ff88] blur-xl opacity-30 group-hover:opacity-50 transition-opacity" />
          </button>
          
          {/* Pulse ring effect */}
          <div className="absolute inset-0 rounded-lg border-2 border-[#00ff88] animate-ping opacity-20" />
        </div>
